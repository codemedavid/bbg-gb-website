...
import { useAdminGroupBuys, useMutate } from './adminApi';
import { Modal, field, Labeled, btnPrimary, btnGhost } from './ui';
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {isLoading ? <div className="text-ink-muted">Loading…</div> : gbs.map((g) => {
          const progress = Math.round((g.claimedSlots / g.totalSlots) * 100);
          return (
