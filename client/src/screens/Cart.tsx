      ...
      <div className="p-4">
        ...
        {items.length > 0 && (
          <>
            ...
            <button onClick={() => nav('/checkout')} className="mt-3.5 block w-full rounded-[12px] bg-brand-blue py-[15px] text-center text-[15px] font-bold text-white active:scale-[.99]">
              Proceed to checkout
            </button>
          </>
        )}
