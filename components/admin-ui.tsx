...
// The admin search box. One token so the boxes on the products, hatian and
// accounts screens stay the same control rather than three lookalikes.
export const searchInput = 'w-full rounded-[10px] border border-line bg-white px-3 py-1.5 text-[13px] sm:w-72';
